import { app, BrowserWindow, ipcMain, IpcMainEvent, OpenDialogOptions, dialog } from 'electron';
import { SelectFileChannel, WalkChannel } from "./preload/IpcChannel";
...
ipcMain.handle(
  ...
  (_event: IpcMainEvent, openDialogOptions?: OpenDialogOptions): string[] => {
